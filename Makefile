...
#COMPILE    = avr-gcc -std=gnu99 -Wall -Winline -mint8 -O3 -funroll-loops -DF_CPU=$(CLOCK) -mmcu=$(DEVICE)
COMPILE    = avr-gcc -std=gnu99 -Wall -Winline -O3 -funroll-loops -DF_CPU=$(CLOCK) -mmcu=$(DEVICE)
